...
> 需要看畫面時開①。
>
> **凍結時間點：2026-09-04 版畫布**。七個 artboard（1a／1b／1c／1d／2a／**2b**／3a）全部是逐字擷取的規格。
>
...
>
> ⚠️ **`dc-import` 的元件內容就在 artifact 裡**（`CopilotPanel.dc.html`：2026-09-04 版解開後 **84 KB**（gzip 前 20.8 KB），第 6 區塊與涵蓋範圍選擇器都在裡面，不在 `page.html`），
