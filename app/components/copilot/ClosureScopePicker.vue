  ...
  <div class="flex flex-col gap-[7px]">
    ...
    <template v-if="open">
      ...
      >
        ...
        <!--
          `zeroTop`：這一句原本是我方追加的（舊 `DESIGN_FEEDBACK.md` D-6）——
          畫布當時認為灰掉的那一列自己就是說明，但那一列只說「這個起點沒有新訊息」，
          沒說「所以系統幫你改選了下一個」。選擇結果被系統動過而客服不知道，
          正是憲法 8.1 要避免的情形。
          ✅ **2026-09-08 版畫布已採納**（連同無框旁注的樣式），這裡不再是偏離。
          ⚠️ 樣式跟著 `overflow` 那種**無框的旁注**，不是 `never` 的告知卡 ——
