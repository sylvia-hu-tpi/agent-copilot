 ...
 *    淺／深色主題切換鈕（畫布 2026-09-08 新增，`DESIGN_TOKENS.md` §8.1）。
 ...
 *    但 **2026-09-08 版畫布全檔只剩「已連線」**（1c 與 1d 皆是），已不再是偏離。
 */
...
/**
 * 淺／深色主題切換（畫布 2026-09-08 新增，`DESIGN_TOKENS.md` §8.1）。
 *
      ...
      <div class="ml-auto flex items-center gap-3">
        ...
        <!--
          ⚠️ `-ml-0.5`（-2px）是畫布逐字的做法，**不是隨手微調** ——
             頂列的 `gap` 是 12px，而分隔線兩側要各 10px（2026-09-08 版畫布定案）。
