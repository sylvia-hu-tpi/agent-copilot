...
- [x] T052 **人工驗收 SC-005（＝ 003 SC-007 重跑，FR-003）** —— **2026-09-04 使用者決定放行並關閉本項**：3 人訪談**未執行**，改由使用者後續與 PM 確認。⚠️ 勾選代表「本規格不再追這項」，**不代表 SC-005 已通過**；驗收紀錄（quickstart §6.2／§6.4）逐字記為未執行。原任務內容：找 **3 位未參與本專案**的人，只給他們看中欄上方狀態列的兩顆按鈕與 `conversation.exitHint` 那行文案，**在按下之前**請他們說出「哪一個會留下紀錄」；3/3 通過才算過。結果（受測者代號、回答、日期）記入 T059。⚠️ 這是獨立任務，MUST NOT 被「結案」而非「驗證」（research #23）
