...
- **與 003 相同的刻意取捨**：四則 User Story 的敘述保留了函式與欄位層級的細節
  ...
  下一個讀者無從判斷修對了沒有。需求本體（FR-001～FR-021 及 2026-09-02 clarify 新增的 FR-005a／FR-006a／FR-015a／FR-018a／FR-020a，共 26 條）維持技術中立：
...
- **範圍問題於 2026-09-02 全數與使用者裁定，無待決項目**。先是兩個範圍決定：
  ...
  憑證登記需存活兜底（FR-005a）、量測口徑 n=45（並行度掃描為每檔位 n=45，見 FR-018a；
  杜撰率為 15 段對話 × 3 輪 ＝ 45 次帶命中的生成，見 FR-017 —— 杜撰率沒有「檔位」這個維度）。
